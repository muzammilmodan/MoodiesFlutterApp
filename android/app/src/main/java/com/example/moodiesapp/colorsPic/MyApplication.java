package com.example.moodiesapp.colorsPic;
...
//    public static final String LISTURL = EXTRAURL + "coloring_page.php?id=";
    ...
    /*deprecated*/
    //Todo: Mujju
    //public static final String SECRETGARDENLOCATION = "/data/user/";
    public static final String SECRETGARDENLOCATION = "assets://SecretGarden/";
    ///data/user/0/com.v_pull/cache/
...
//    public static final String MainUrl = "http://sgdaemon.cloudapp.net/pic_dev/extAPI";
    ...
    public static final String UserRegisterUrSecretGardenl = MainUrl + "/register";  //post type uid usericon gender location name
