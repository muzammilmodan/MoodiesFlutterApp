...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        try {
            ...
            // ✅ FIX: Only cast if this activity IS an AppCompatBaseAcitivity
            // GridViewActivity and PaintActivity extend BaseActivity directly,
            // so casting them throws ClassCastException
            if (this instanceof AppCompatBaseAcitivity) {
                ((AppCompatBaseAcitivity) this).setmSwipeRefreshLayout(swipeRefreshLayout);
            }
