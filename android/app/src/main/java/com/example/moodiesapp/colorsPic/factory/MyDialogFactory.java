package com.example.moodiesapp.colorsPic.factory;
...
import com.example.moodiesapp.colorsPic.listener.OnUnLockImageSuccessListener;
import com.example.moodiesapp.colorsPic.model.AsynImageLoader;
import com.example.moodiesapp.colorsPic.util.*;
import com.example.moodiesapp.colorsPic.view.ColorPickerSeekBar;
import com.example.moodiesapp.colorsPic.view.MyDialogStyle;
...
public class MyDialogFactory extends MyDialogStyle {
    ...
    public void showSettingDialog() {
        ...
        radioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.CN) {
                MyApplication.setLanguageCode(context, 1);

            } else if (checkedId == R.id.TW) {
        ...
        radioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.small) {
                editText.setTextSize(TypedValue.COMPLEX_UNIT_SP,
                        DragTextViewFactory.getInstance().SmallTextSize);

            } else if (checkedId == R.id.middle) {
                editText.setTextSize(TypedValue.COMPLEX_UNIT_SP,
                        DragTextViewFactory.getInstance().MiddleTextSize);

            } else if (checkedId == R.id.large) {
                editText.setTextSize(TypedValue.COMPLEX_UNIT_SP,
                        DragTextViewFactory.getInstance().BigTextSize);

            } else if (checkedId == R.id.huge) {
                editText.setTextSize(TypedValue.COMPLEX_UNIT_SP,
                        DragTextViewFactory.getInstance().HugeSize);
            }
        });
