...
//        String path = Environment.getExternalStorageDirectory().getPath() + "/MyGallaryWorks";
...
//    }
    ...
    public static void deleteAllPaints() {
        File dir = new File(Environment.getExternalStorageDirectory().getPath() + "/MyGallaryWorks");
        if (dir.isDirectory()) {
